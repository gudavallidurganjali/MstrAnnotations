...
(function($) {
    ...
    Annotate.prototype = {
        ...
        mousemove: function(event) {
            ...
            var offset = self.$el.offset();
			// if(self.options.type!="rectangle"){
			// if((self.fromx == event.pageX || self.fromx == (event.pagex +1) || self.fromx == (event.pageX-1))&& (self.fromy == event.pageY-offset.top || self.fromy == (event.pageY-offset.top +1) || self.fromy == (event.pageY-offset.top -1))){
				// return;				
			// }
			// }
            if (self.options.type === "rectangle") {
        ...
        saveImage: function() {
			...
			$('#narrativeForPDF').append('<div class="row narrativePDf"><div class="col-md-12" style="background-color:lightBlue; border-Color: lightBlue;"><b>Scenario Narrative</b></div></br><div class="col-md-12" style="border-Color:lightBlue; background-color:white; height:400px">'+self.narrative+'</div></div>');
        ...
        deleteAnnotation: function() {
            ...
            if (self.deleteElement != null) {
                for (var i = 0; i <= self.storedElement.length - 1; i++) {
                    if (unDeletedItem[i].fromx == self.deleteElement.fromx) {
    ...
    $.fn.annotate = function(options, newImage) {
        ...
        } else if (options == "deleteAnnotation") {
            if ($(this).data("annotate")) {
                $(this).data("annotate").deleteAnnotation();
            }
        } else {
